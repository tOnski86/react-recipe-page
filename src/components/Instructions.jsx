  ...
  return (
    <div className='mb-8 pb-8 border-b-[1px]  border-stone-100'>
      ...
      <ol className='marker:text-brown marker:font-bold list-decimal *:pb-2 px-7'>
        <li className='pl-4'>
          <span className='text-stone-600 font-bold'>Beat the eggs:</span> In a
        ...
        <li className='pl-4'>
          <span className='text-stone-600 font-bold'>Heat the pan:</span> Place
          a non-stick frying pan over medium heat and add butter or oil.
        </li>
        <li className='pl-4'>
          <span className='text-stone-600 font-bold'>Cook the omelette:</span>{' '}
        ...
        <li className='pl-4'>
          <span className='text-stone-600 font-bold'>Fold and serve:</span> As
        ...
        <li className='pl-4'>
          <span className='text-stone-600 font-bold'>Enjoy:</span> Serve hot,
